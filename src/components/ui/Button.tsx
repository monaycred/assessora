...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        "bg-dark-800 text-dark-100 hover:bg-dark-700 focus:ring-dark-600 border border-dark-700",
      ghost:
        "bg-transparent text-dark-100 hover:bg-dark-800 focus:ring-dark-600",
      danger:
